...
public:
    explicit ProfileDialog( QWidget* parent = 0, Qt::WindowFlags f = 0 );
...
private slots:
    ...
    void listItemRenamed( Q3ListViewItem* item, const QString& text, int col );
...
private:
    ...
    QMap<Q3ListViewItem*, QString> m_itemToProfile;
    QMap<QString, Q3ListViewItem*> m_profileToItem;
};
